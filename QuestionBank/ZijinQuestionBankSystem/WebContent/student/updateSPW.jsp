			...
			<div class="col-md-12 column">
				...
				<div class="container-fluid">
					<div class="navbar-header">
						<a class="navbar-brand" href="studentHome.jsp">紫金试题库系统</a>
					</div>
					<div>
				...
				<div class="col-md-6 col-md-offset-3">
					...
					<form class="form-horizontal" role="form"
						action="../UpdatePW?method=updateSPW" method="post">
						<div class="form-group">
							<label for="lastname" class="col-sm-5 control-label"><font
								color="white">旧密码</font></label>
							<div class="col-sm-7">
								<input type="password" class="form-control" name="oldcode"
									placeholder="请输入旧密码">
							</div>
						</div>
						<div class="form-group">
							<label for="lastname" class="col-sm-5 control-label"><font
								color="white">新密码</font></label>
							<div class="col-sm-7">
								<input type="password" class="form-control" name="newcode1"
									placeholder="请输入新密码">
							</div>
						</div>
						<div class="form-group">
							<label for="lastname" class="col-sm-5 control-label"><font
								color="white">确定新密码</font></label>
							<div class="col-sm-7">
