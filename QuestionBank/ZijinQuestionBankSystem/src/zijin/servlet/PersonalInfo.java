...
/**
 * 文件名：PersonalInfo.java
 * 作用：查看用户信息（上一级查看teacher admin）更新用户信息
 * 创建者：陈天、瞿嘉乐、季洋洋、朱凯
 * 创建时间：
 * 
 */
...
public class PersonalInfo extends HttpServlet {
	...
	private void findAdminInfo(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		PrintWriter   out   =   response.getWriter(); 
		out.println("<script>window.location.href='/ZijinQuestionBankSystem/admin/adminInfo.jsp'</script>");
		}
	...
	private void findTeacherInfo(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		PrintWriter   out   =   response.getWriter(); 
		out.println("<script>window.location.href='/ZijinQuestionBankSystem/teacher/teacherInfo.jsp'</script>");
		}
	...
	private void findStudentInfo(HttpServletRequest request, HttpServletResponse response) throws IOException {
			...
			PrintWriter   out   =   response.getWriter(); 
			out.println("<script>window.location.href='/ZijinQuestionBankSystem/student/studentInfo.jsp'</script>");
		}
